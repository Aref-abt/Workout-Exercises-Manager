...
class _ExerciseLogScreenState extends State<ExerciseLogScreen> {
            ...
            children: [
              ExerciseCard(
                ...
                onProgressChanged: (progress) {
                  updateGoalsScreen(squats: progress);
                },
              ),
              ...
              ExerciseCard(
                ...
                onProgressChanged: (progress) {
                  updateGoalsScreen(deadlifts: progress);
                },
              ),
              SizedBox(height: 16.0),
              ExerciseCard(
                ...
                onProgressChanged: (progress) {
                  updateGoalsScreen(burpees: progress);
                },
              ),
            ],
          ),
 ...
 //update the goal screen
  void updateGoalsScreen(
    ...
    setState(() {
      squatsProgress = squats;
      deadliftsProgress = deadlifts;
      burpeesProgress = burpees;
    });
  }
}
